...
class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBarWidget(
          title: 'home_screen.app_title'.tr(),
      ...
      body: Stack(
        children: [
          ...
          Padding(
            padding:
                EdgeInsets.symmetric(horizontal: width_8, vertical: height_20),
            child: Column(
              children: [
                Center(
                  child: GestureDetector(
                    onTap: () async {
                      ...
                      if (isSend) {
                        showToast(
                          message: 'home_screen.send_alert_success'.tr(),
                        );
                      } else {
                        showToast(
                          message: 'home_screen.send_alert_failure'.tr(),
                        );
                      }
                    },
                    child: Container(
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: Colors.white
                        .withOpacity(0.7), // Màu nền với độ trong suốt
                    borderRadius:
                        BorderRadius.circular(20.0), // Bo góc các cạnh
                  ),
                  child: Text(
                    ...
                    Expanded(
                      child: GestureDetector(
                        onTap: () async {
                          ...
                          if (!isCallOpened) {
                            showToast(
                              message: 'home_screen.call_not_supported'.tr(),
                            );
                          }
                          ...
                          child: Column(
                            ...
                            children: [
                              const Icon(Icons.phone,
                                  color: Colors.orange, size: 30), // Icon Gọi
                              const SizedBox(height: 10),
                              Text(
                      ...
                      child: GestureDetector(
                        ...
                        child: Container(
                          padding: EdgeInsets.symmetric(
                              vertical: height_8, horizontal: width_16),
                          width: width_250,
                          height: height_85,
                          decoration: BoxDecoration(
                            color: Colors.white,

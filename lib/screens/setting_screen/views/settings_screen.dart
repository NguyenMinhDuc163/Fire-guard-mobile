...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  Future<void> _handleUpdateEmail(BuildContext context, String newEmail) async {
    ...
    final message = success
        ? 'settings.settings_email_update_success'.tr()
        : viewModel.error ?? 'settings.settings_email_update_failed'.tr();
  ...
  Future<void> _handleUpdatePhone(BuildContext context, String newPhone) async {
    ...
    final message = success
        ? 'settings.settings_phone_update_success'.tr()
        : viewModel.error ?? 'settings.settings_phone_update_failed'.tr();
    final color = success ? Colors.green : Colors.red;
  ...
  Future<void> _handleUpdateClickSend(
    ...
    final message = success
        ? 'settings.settings_clicksend_update_success'.tr()
        : viewModel.error ?? 'settings.settings_clicksend_update_failed'.tr();
    final color = success ? Colors.green : Colors.red;

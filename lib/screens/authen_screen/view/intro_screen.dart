            ...
            PageView(
              ...
              children: [
                _buildItemIntroScreen(
                    AssetHelper.slide1,
                    "intro.titleIntro1".tr(),
                    "intro.contentIntro1".tr(),
                    Alignment.center,
                    AssetHelper.icoRectanglePink),
                _buildItemIntroScreen(
                    AssetHelper.slide2,
                    "intro.titleIntro2".tr(),
                    "intro.contentIntro2".tr(),
                    Alignment.center,
                    AssetHelper.icoRectangleBlue),
                _buildItemIntroScreen(
                    AssetHelper.slide3,
                    "intro.titleIntro3".tr(),
                    "intro.contentIntro3".tr(),
                    Alignment.center,
                    AssetHelper.icoRectanglePink),
              ],
            ),
                      ...
                      builder: (context, snapshot) {
                        return Expanded(
                          ...
                          child: ButtonIntroWidget(
                            title: (snapshot.data != 2) ? "intro.buttonNext".tr() : "intro.buttonGetStarted".tr(),
                            ontap: () {
